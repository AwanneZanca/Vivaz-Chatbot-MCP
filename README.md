...
```json
{
  "mcpServers": {
    "vivaz-chatbot": {
      "command": "C:\\Users\\zanca\\OneDrive\\Área de Trabalho\\Vivaz_Chatbot\\mcp-server\\.venv\\Scripts\\python.exe",
      "args": ["C:\\Users\\zanca\\OneDrive\\Área de Trabalho\\Vivaz_Chatbot\\mcp-server\\server.py"]
    }
  }
}
```
